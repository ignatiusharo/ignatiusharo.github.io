		...
		<ul class="biz-ex-element-actions">
			{{if presentationAction}}
				...
				{{if presentationAction.type === 'url'}}
					<li class="biz-ex-element-action">
						<a href="${Bizagi.Util.validateHttp(Bizagi.Util.serializeResourceURL(presentationAction.value))}" class="biz-ex-action-url biz-ex-icon-url" data-action="url"></a>
					</li>
				{{/if}}
...
@import "theme-client.css";
	...
	<div id="image-renderer" style="position: absolute; width: 10000px; opacity: 0;"></div>
	</body>
</html>